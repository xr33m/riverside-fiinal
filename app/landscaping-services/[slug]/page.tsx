...
const SERVICE_REAL_PHOTOS: Record<string, GalleryImage[]> = {
  ...
  'composite-decking-glasgow': [
    ...
    { src: '/images/portfolio/ai-gallery-decking-finished.webp', alt: 'Finished composite decking area with outdoor furniture', position: 'object-center' },
    { src: '/images/portfolio/patio-dark-decking.webp', alt: 'Composite deck adjoining a patio area', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-decking-construction.webp', alt: 'Composite decking sub-frame under construction', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-decking-boards.webp', alt: 'Detail of composite decking boards and hidden fixings', position: 'object-center' },
  ],
  'garden-fencing-glasgow': [
    ...
    { src: '/images/portfolio/ai-gallery-fencing-dusk.webp', alt: 'Slatted privacy fencing enclosing a garden at dusk', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-fencing-wide.webp', alt: 'Newly installed horizontal slatted timber fencing', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-fencing-footing.webp', alt: 'Fence post being set into a concrete footing', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-fencing-joinery.webp', alt: 'Detail of timber fence panel joinery and fixings', position: 'object-center' },
  ],
  'artificial-grass-glasgow': [
    ...
    { src: '/images/portfolio/ai-gallery-turf-wide.webp', alt: 'Lush artificial grass lawn bordered by planting', position: 'object-center' },
    ...
    { src: '/images/portfolio/ai-gallery-turf-detail.webp', alt: 'Detail of realistic artificial turf blades', position: 'object-center' },
  ],
  'garden-landscaping-glasgow': [
    ...
    { src: '/images/portfolio/ai-gallery-landscaping-construction.webp', alt: 'Full garden redesign mid-construction with groundworks underway', position: 'object-center' },
  ...
  'garden-rooms-glasgow': [
    ...
    { src: '/images/portfolio/ai-gallery-gardenroom-exterior.webp', alt: 'Modern insulated garden room at dusk', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-gardenroom-deck.webp', alt: 'Garden room connected to a composite decking platform', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-gardenroom-foundation.webp', alt: 'Screw-pile foundations being installed for a garden room', position: 'object-center' },
  ],
  'garden-drainage-solutions-glasgow': [
    { src: '/images/portfolio/ai-gallery-drainage-lawn.webp', alt: 'Healthy lawn with no standing water after drainage work', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-drainage-trench.webp', alt: 'French drain trench being installed with perforated pipe', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-drainage-slot-detail.webp', alt: 'Detail of a slot drain channel embedded in a patio edge', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-drainage-catchbasin.webp', alt: 'Drainage catch basin inspection cover set into a lawn edge', position: 'object-center' },
  ],
  'resin-bound-driveways-glasgow': [
    { src: '/images/portfolio/ai-gallery-resin-driveway.webp', alt: 'Finished resin bound driveway outside a Scottish house', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-resin-curved.webp', alt: 'Curved resin bound driveway leading to a house', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-resin-laying.webp', alt: 'Resin bound driveway being laid over an asphalt base', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-resin-texture.webp', alt: 'Detail of resin bound driveway aggregate texture', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-resin-border.webp', alt: 'Detail of a resin bound driveway edge border', position: 'object-center' },
  ],
  'retaining-walls-glasgow': [
    { src: '/images/portfolio/ai-gallery-walls-tiered.webp', alt: 'Tiered garden with engineered stone retaining walls', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-walls-porcelain-terrace.webp', alt: 'Curved porcelain-faced retaining wall terrace with steps', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-walls-construction.webp', alt: 'Retaining wall under construction with concrete footing', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-walls-whinstone.webp', alt: 'Detail of Scottish whinstone retaining wall with weep holes', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-walls-brick-boundary.webp', alt: 'Low garden brick boundary wall matching a house facade', position: 'object-center' },
  ],
  '3d-garden-design-glasgow': [
    { src: '/images/portfolio/ai-gallery-3ddesign-isometric.webp', alt: 'Isometric 3D render of a garden design with deck and seating', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-3ddesign-topdown.webp', alt: 'Top-down flat plan render of a garden layout design', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-3ddesign-night.webp', alt: '3D render of a garden design showing night lighting', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-3ddesign-palette.webp', alt: 'Material and planting palette board for a garden design', position: 'object-center' },
    { src: '/images/portfolio/ai-gallery-3ddesign-section.webp', alt: 'Technical cross-section render of sub-base and drainage layers', position: 'object-center' },
  ],
}
