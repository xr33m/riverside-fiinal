...
/* ------------------------------------------------------------------ *
 * Glassmorphic Shrinking Header Navigation with Dropdown Menus
 * ------------------------------------------------------------------ */
  ...
  return (
    <header className={`site-header transition-all duration-300 ${scrolled ? 'site-header-scrolled' : ''}`}>
      ...
      <nav className="hidden items-center gap-5 md:flex text-sm">
        ...
        <a href="/#proof" className="hover:text-accent">Proof</a>
        <a href="/#portfolio" className="hover:text-accent">Portfolio</a>
        <a href="/#faq" className="hover:text-accent">FAQs</a>
        <a
          href={BRAND.phoneHref}
          className="flex items-center gap-1.5 font-bold text-primary hover:text-accent"
